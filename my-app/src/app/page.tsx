            ...
            <div className="container p-6 mx-auto ">
                <div className="flex mt-8">
                    <div className="w-2/4 h-auto ">
                        ...
                        <p className="px-16 py-12 text-gray-500 text-lg text-justify">
                            "Transform your skills and unlock new opportunities with our flexible,
                            engaging courses. Learn what you love, at your own pace, and achieve
                            your personal or professional goals today."
                        </p>
                        <div className="px-16">
                    ...
                    <div className=" text-center  flex flex-col justify-center w-full">
                        <h1 className="text-4xl font-extrabold  text-center">
                            ...
                            <span className="text-red-300">
                                Explore, Create, and Achieve with Our Comprehensive Curriculum
                            </span>
                        </h1>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-36 border-b-2 border-gray-300">
                    <div className="bg-cyan-50 p-8 py-12 rounded-3xl shadow-lg flex flex-col ">
                        ...
                        <p className="text-gray-600 leading-relaxed text-justify">
                            Looking to expand your skills and explore your creativity? Our hands-on
                            creative classes are the perfect way to learn at your own pace and
                    ...
                    <div className="bg-red-50 p-8 py-12 rounded-3xl shadow-lg flex flex-col justify-between text-justify">
                        <h2 className="text-2xl text-gray-700 font-bold mb-8">
                            LinguaX teachers are everyday creatives and professionals who want to
                            share their passion.
                        </h2>
                        <p className="text-gray-600 leading-relaxed">
                            At LinguaX, our teachers are not just experts in their field; they are
                            passionate about helping others discover their own creativity. They
                            tailor their instruction to meet individual needs and goals.
                        </p>
                    </div>
                    ...
                    <div className="bg-yellow-100 p-8 py-12 rounded-3xl shadow-lg flex flex-col justify-between text-justify">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            With a variety of courses, you'll find something to spark your interest
                            and inspire your creativity. Learn from experts and take your skills to
                            the next level.
                        </p>
                    </div>
                </div>
                ...
                <div className="container flex mt-24">
                    ...
                    <div className="w-1/2 h-auto mt-24">
                        ...
                        <p className="text-gray-500 mt-8 text-xl text-justify">
                            ...
                            interactive classes designed to inspire growth and creativity. Learn
                            from the best, at your own pace, and take your skills to the next level.
                        </p>
                        <p className="mt-6 text-blue-500">✔ Learn From Industry Leaders</p>
                        <p className="mt-3 text-blue-500">✔ Engage in Real-World Projects </p>
                        <p className="mt-3 text-blue-500">
                            ✔ Comprehensive and Flexible Curriculum
                        </p>
                        <p className="mt-6 text-gray-500 text-xl">
                            Empower yourself with the knowledge and tools to succeed, guided by
                            passionate instructors and a supportive community. Your journey starts
                            here!
                        </p>
                    </div>
                </div>
                <div className=" container mt-24">
                    ...
                    <p className="text-gray-500 text-xl text-center mb-16">
                        Discover how LearnEasy's innovative courses empower you to gain new skills,
                        <br />
                        boost confidence, and excel in both personal and professional pursuits.
                    </p>
                    <CommentList />
                </div>
            </div>
